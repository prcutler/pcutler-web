...
class EasyContactFormsCustomForms extends EasyContactFormsBase {
	...
	function preview($map) {
		...
		$index .= "<script type='text/javascript' src='" . EASYCONTACTFORMS__engineWebAppDirectory . "/easy-contact-formshtml.1.4.js'></script>";
	...
	function refreshForm($map) {
		...
		$text[] = "<script type='text/javascript' src='" . EASYCONTACTFORMS__engineWebAppDirectory . "/easy-contact-forms-forms.1.4.js'></script>";
