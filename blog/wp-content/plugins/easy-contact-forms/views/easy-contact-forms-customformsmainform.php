          ...
          <fieldset>
            ...
            <div class='ufo-float-left ufo-width50'>
              ...
              <div>
                 ...
                 <textarea id='SubmissionSuccessText' class='textinput ufo-textarea ufo-formvalue' style='width:100%;height:230px'><?php echo $obj->get('SubmissionSuccessText');?></textarea>
              </div>
            </div>
            <div class='ufo-float-right ufo-width50'>
              <div>
              ...
              <div style='padding:10px'>
                 ...
                 <div class='ufo-float-right ufo-width50'>
                   <div style='padding:10px'>
                     ...
                     <input type='hidden' id='Hint' value='<?php echo EasyContactFormsT::get('Hint_CustomForms_LineMarginHeight');?>' class='ufo-id-link'>
                     <div style='position:relative;padding-right:50px'>
                 ...
                 <a href='http://easy-contact-forms.com/simple-split' target=_blank>More styles</a>
                 <label for='FormClass'>
