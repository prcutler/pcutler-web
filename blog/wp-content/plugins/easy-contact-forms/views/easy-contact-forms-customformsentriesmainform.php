...
?>
  <div>
    <?php EasyContactFormsLayout::getTabHeader(array('GeneralInfo', 'EntryFiles'), 'top');?>
        ...
        <div>
          <div>
            ...
            <div class='ufo-y-overflow'>
              <div style='width:100%;height:256px'><?php echo $obj->get('Content');?></div>
            </div>
          </div>
        </div>
      </div>
      <div id='EntryFiles' class='ufo-tabs ufo-tab'>
        <input type='hidden' value='AppMan.initRedirect("EntryFiles", {specialfilter:"[{\"property\":\"CustomFormsEntries\", \"value\":{\"values\":[<?php echo $obj->get('id');?>]}}]", viewTarget:"CustomFormEntryFilesDiv", t:"CustomFormEntryFiles", m:"viewDetailed"}, [{property:"CustomFormsEntries", value:{values:[<?php echo $obj->get('id');?>]}}])' class='ufo-eval'>
