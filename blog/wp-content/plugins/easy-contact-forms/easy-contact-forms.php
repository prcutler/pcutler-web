...
function easycontactforms_entrypoint() {
	...
	wp_enqueue_script('easy-contact-formshtml.1.4', '/' . _EASYCONTACTFORMS_DIR . '/easy-contact-formshtml.1.4.js');
...
function easycontactforms_formentrypoint($map) {
	...
	if (!$as->get('FixJSLoading')) {
		wp_enqueue_script('ufoforms', '/' . _EASYCONTACTFORMS_DIR . '/easy-contact-forms-forms.1.4.js');
	} else {
	$js = '<script src="' . $base . '/' . _EASYCONTACTFORMS_DIR . '/easy-contact-forms-forms.1.4.js"></script>';
	}
